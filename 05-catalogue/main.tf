#first we are creating the target group for our catalogue component
...
#below is catalogue launch template 
...
#below we are creating catalogue autoscalinggroup 
...
#below we are creating catalogue autoscaling group policy
...
resource "aws_lb_listener_rule" "catalogue" {
  ...
  condition {
    host_header {
      values = ["catalogue.app.nishaldevops.online"]
    }
  }
}